...
//MEMBER
$route['home'] = 'member/homeMember';
$route['login'] = 'member/login';
$route['signup'] = 'member/register';

//FUTSAL
$route['indexFutsal'] = 'futsal/indexFutsal';
$route['signupfutsal'] = 'futsal/registerFutsal';
$route['dashboardFutsal'] = 'futsal/dashboardFutsal';
